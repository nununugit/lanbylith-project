...
4. 所有者：全ての権限を持っている、所有グループ：読み、書きの権限を持っている、その他のユーザ：読みの権限を持っている' ,
        ...
        $param = [
            'title'=>'9. 編集した後は保存が必須！',
            'lv_lvid'=>'2',
            'content'=>'nanoコマンドでファイルの編集をしたあと、そのファイルを保存をするにはどのような操作をすれば良いか。以下の選択肢から2つ、順番にカンマ(,)で区切って番号で答えよ。
			1. Ctrlキーを押しながらXを押す
			2. Shiftキーを押しながらAを押す
			3. Yを押す
			4. Shiftキーを押しながらXを押す
        ...
        $param = [
            ...
            'lv_lvid'=>'2',
            'content'=>'いま、新しくパスワード(パスフレーズとの表記揺れ？)を設定するとする。それに当たって、以下の選択肢のうち、間違っていることを選択肢から選び、番号で答えよ。
            答え方：選択肢a,b,cがあり、a,cが正答だと思う場合はCST{a,c}と入力する。
        ...
        $param = [
            'title'=>'2. 数字参戦！？',
            'lv_lvid'=>'3',
            'content'=>'orange.txtファイルのパーミッションを「-rwxr-xr--」にしたい。もっとも適したコマンドを以下の選択肢から2つ選び、番号で答えよ。
        ...
        $param = [
            'title'=>'6. もっともっと簡単に！',
            'lv_lvid'=>'3',
            'content'=>'ホームディレクトリに移動する際、ホームディレクトリ名を入れなくても移動できるコマンドの表現方法がある。以下の選択肢よりホームディレクトリに移動できるコマンドをすべて選び、数字の小さい順にカンマ区切りで答えよ。
            1. cd /home
            2. cd –
            3. cd
            4. cd *
